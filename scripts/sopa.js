...
var SOPA = {
    init: function() {
        ...
        if ((date.getFullYear() === 2012) && ((date.getMonth() + 1) === 1) && (date.getDate() === 18) && ((date.getHours() + 1) < 20)) {
            var $div = $('<div style="position: absolute; color: #FFF; top: 0; left: 0; width: 100%; height: 100%; z-index: 1000; text-align: center; background: rgba(0,0,0,1); font-size: 18px; font-weight: bold; "/>')
